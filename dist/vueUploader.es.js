...
const { where, uuid, UPLOAD_STATUS, log: log$1, createObjectURL } = func;
...
var baseView = {
  ...
  methods: {
    initDragAndResize(){
      ...
      // 节流提高效率
      const onDocumentMove = _lodash_throttle_4_1_1_lodash_throttle(function(e){
...
export { main$1 as VueImageUploader, main as VueVideoUploader };
